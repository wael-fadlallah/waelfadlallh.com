...
/** Smoothing factor for mouse position interpolation per frame */
const MOUSE_POSITION_LERP = 0.1;
/** Smoothing factor for mouse influence interpolation per frame */
const MOUSE_INFLUENCE_LERP = 0.05;
...
void main() {
    ...
    const handleMouseMove = (e: MouseEvent) => {
      ...
      if (isInside) targetMouseRef.current = { x, y };
    };
    ...
    const render = (t: number) => {
      ...
      mousePositionRef.current.x +=
        (targetMouseRef.current.x - mousePositionRef.current.x) * MOUSE_POSITION_LERP;
      mousePositionRef.current.y +=
        (targetMouseRef.current.y - mousePositionRef.current.y) * MOUSE_POSITION_LERP;
      ...
      uniforms.mouseInfluence.value +=
        (targetInfluence - currentInfluence) * MOUSE_INFLUENCE_LERP;
